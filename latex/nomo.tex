...
\usepackage{microtype}                % Microtypography for improved text layout
\usepackage{graphicx}                 % Enhanced graphics handling
...
\section*{\centerline{Теорема сложения}}

\subsection*{Теорема и ее связи}

Рассмотрим два множества $A$ и $B$.
Если множество $A$ содержит $n(A)$ элементов,
а множество $B$ — $n(B)$ элементов
и пересечение множеств $A$ и $B$ не пусто,
то число элементов в их объединении $n(A\cup B)$ вычисляется по формуле:
\begin{gather*}
